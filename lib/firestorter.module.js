...
import { deleteField, getFirestore as getFirestore$1, updateDoc, setDoc, deleteDoc, onSnapshot, doc, getDoc, collection, getDocs, addDoc, query, where } from 'firebase/firestore';
...
function mergeUpdateData(data, fields, _hasContext) {
    ...
    var canonicalDelete = deleteField();
...
function makeFirestorterContext(config) {
    ...
    var firestore = (config === null || config === void 0 ? void 0 : config.firestore) || getFirestore$1(firebaseApp);
    if (!firestore) {
...
var Document = /** @class */ (function () {
    ...
    Document.prototype._updateSourceObserver = function () {
        ...
        if (typeof this.sourceInput === 'function') {
            this.sourceDisposerFn = reaction(function () { return _this.sourceInput(); }, function (value) {
                runInAction(function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, addDoc(ref, data)];
                    case 1:
                        ref2 = _a.sent();
                        return [4 /*yield*/, getDoc(ref2)];
                    case 2:
                        snapshot = _a.sent();
    ...
    function GeoQuery(source, options) {
        ...
        _this = _super.call(this, source, __assign({ filterBy: filterBy
                ...
                return geohashes.map(function (geohash) { return ({
                    ...
                    query: function (ref) {
                        return query(ref, where(fieldPath, '>=', geohash[0]), where(fieldPath, '<', geohash[1]));
                    },
                }); });
            } }, otherOptions)) || this;
