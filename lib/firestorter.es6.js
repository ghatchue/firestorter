...
function makeFirestorterContext(config) {
    ...
    const firestore = (config === null || config === void 0 ? void 0 : config.firestore) || Lc$1(firebaseApp);
    if (!firestore) {
...
class Collection {
    ...
    add(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Add to firestore
            const ref2 = yield Th(ref, data);
            const snapshot = yield hh(ref2);
    ...
    constructor(source, options) {
        ...
        super(source, Object.assign({ filterBy: filterBy
                ...
                return geohashes.map((geohash) => ({
                    ...
                    query: (ref) => Uu(ref, Ku(fieldPath, '>=', geohash[0]), Ku(fieldPath, '<', geohash[1])),
                }));
            } }, otherOptions));
